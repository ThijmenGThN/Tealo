...
var _this = this;
module.exports = {
    global: function () { return __awaiter(_this, void 0, void 0, function () {
        var G, exp, site;
        return __generator(this, function (_a) {
            ...
            exp = G.node.express();
            site = G.node.http.Server(exp);
            exp.get("/", function (err, data) { data.sendFile(__dirname + G.config.site.root + G.config.site.file); });
